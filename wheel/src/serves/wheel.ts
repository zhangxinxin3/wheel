...
export function detail(params: any) {
    return request({
        url: "http://baojia.chelun.com/v2-car-getInfoAndListById.html?SerialID=" + params + "&_1563195473209",
        method: "GET"
    })
}
//首页车系
...
//图片列表 
export function imglist(params: any) {
    return request({
        url: "/v2-car-getImageList.html?SerialID=" + params + "&_1563452695554",
        method: "GET"
    })
}